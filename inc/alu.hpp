/*
	Class declaration for the three Arithmetic Logic Units (ALUs).
*/
...
protected:
	...
	void operate();										// function to perform the specified operation
public:
	ALU3(Latch< std::tuple<Instruction, int, int> >*, Latch< std::tuple<Instruction, int> >*, bool*);
	void tick();
	void tock();
	void flush(int);
};
